...
from PyQt5.QtCore import pyqtBoundSignal, pyqtSignal, pyqtSlot, QByteArray, QCoreApplication, QDir, QEvent, QEventLoop, QMetaObject, QMutex, QObject, QPoint, QPointF, QProcess, QRect, QRunnable, QSettings, QSize, Qt, QThread, QThreadPool, QTimer, QTimerEvent, QUrl
from PyQt5.QtWidgets import QAbstractItemView, QApplication, QAction, QActionGroup, QBoxLayout, QCheckBox, QColorDialog, QComboBox, QDesktopWidget, QDialog, QDialogButtonBox, QDockWidget, QDoubleSpinBox, QFileDialog, QFontDialog, QFrame
from PyQt5.QtWidgets import QGraphicsView, QGridLayout, QGroupBox, QHBoxLayout, QLabel, QLayout, QLayoutItem, QLineEdit, QListWidget, QListWidgetItem, QMainWindow, QMenu, QMenuBar, QMessageBox, QProgressBar, QProgressDialog, QPushButton
from PyQt5.QtWidgets import QRadioButton, QScrollArea, QShortcut, QSizePolicy, QSlider, QSpacerItem, QSpinBox, QSplitter, QStackedWidget, QStyleFactory, QTableWidget, QTabWidget, QTreeWidget, QTreeWidgetItem, QVBoxLayout, QWidget
from PyQt5.QtGui import QActionEvent, QCloseEvent, QColor, QCursor, QFocusEvent, QFont, QFontMetrics, QHoverEvent, QImage, QKeySequence, QMouseEvent, QMoveEvent, QMovie, QPalette, QPixmap, QResizeEvent, QShowEvent, QScreen, QWindow
...
def get_event_type(event: Union[QEvent, QEvent.Type],
                   dic: Dict[QEvent.Type, str] = {}) -> str:
    """查询 QEvent 对应的名称

    Args:
        event (Union[QEvent, QEvent.Type]): 表示要查询的 QEvent 或者其 .type() 属性
        dic (Dict[QEvent.Type, str], optional): 借以查询的字典。
    ...
    if len(dic) == 0:
        event_names = [
            ...
            "ThreadChange", "WindowActivate", "WindowDeactivate",
            "ShowToParent", "HideToParent", "Wheel", "WindowTitleChange",
            "WindowIconChange", "ApplicationWindowIconChange",
            "ApplicationFontChange", "ApplicationLayoutDirectionChange",
            "ApplicationPaletteChange", "PaletteChange", "Clipboard",
            "MetaCall", "SockAct", "WinEventAct", "DeferredDelete",
            "DragEnter", "DragMove", "DragLeave", "Drop", "ChildAdded",
            "ChildPolished", "ChildRemoved", "PolishRequest", "Polish",
            "LayoutRequest", "UpdateRequest", "UpdateLater", "ContextMenu",
            "InputMethod", "TabletMove", "LocaleChange", "LanguageChange",
            "LayoutDirectionChange", "TabletPress", "TabletRelease",
            "OkRequest", "IconDrag", "FontChange", "EnabledChange",
            "ActivationChange", "StyleChange", "IconTextChange",
            ...
            "ApplicationDeactivate", "ApplicationDeactivated",
            "QueryWhatsThis", "EnterWhatsThisMode", "LeaveWhatsThisMode",
            "ZOrderChange", "HoverEnter", "HoverLeave", "HoverMove",
            "GraphicsSceneMouseMove", "GraphicsSceneMousePress",
            "GraphicsSceneMouseRelease", "GraphicsSceneMouseDoubleClick",
            "GraphicsSceneContextMenu", "GraphicsSceneHoverEnter",
            "GraphicsSceneHoverMove", "GraphicsSceneHoverLeave",
            "GraphicsSceneHelp", "GraphicsSceneDragEnter",
            "GraphicsSceneDragMove", "GraphicsSceneDragLeave",
            "GraphicsSceneDrop", "GraphicsSceneWheel", "GraphicsSceneResize",
            "GraphicsSceneMove", "KeyboardLayoutChange",
            ...
            "UngrabMouse", "GrabKeyboard", "UngrabKeyboard",
            "StateMachineSignal", "StateMachineWrapped", "TouchBegin",
            "TouchUpdate", "TouchEnd", "RequestSoftwareInputPanel",
            "CloseSoftwareInputPanel", "WinIdChange", "Gesture",
            "GestureOverride", "FocusAboutToChange", "ScrollPrepare", "Scroll",
            "Expose", "InputMethodQuery", "OrientationChange", "TouchCancel",
            "PlatformPanel", "ApplicationStateChange", "ReadOnlyChange",
            "PlatformSurface", "TabletTrackingChange", "User", "MaxUser"
        ]
        event_numbers = [
            QEvent.Type.None_,
            QEvent.Type.Timer,
        ...
        dic.update(zip(event_numbers, event_names))
    return dic[event]
